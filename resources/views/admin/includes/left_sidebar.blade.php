        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    @php 
                    $route=(Auth::user()->role=='admin'?'admin.dashboardRoute':(Auth::user()->role=='company'?'company.dashboardRoute':'admin.user.dashboardRoute')); 
                    @endphp
                    @can ('check-route', $route)
                    <li class="nav-active">
                    ...
                    @endcan
                    @if($user->role != "user")
                        @can ('check-route', 'admin.userIndexRoute')
                        @if($user->role == "admin")
                        <li class="nav-active">
                            <a class="nav-link" href="{{route('admin.userIndexRoute')}}">
                        ...
                        @endif
                        @endcan
                        @can ('check-route', 'admin.packages.index')
                        <li>
                            <a href="{{ route('admin.packages.index') }}">
                            <i class="fa fa-cube"></i>
                             <span>Lidmaatschappen</span></a>
                        </li>
                        @endcan
                        @can ('check-route', 'admin.tests.index')
                        <li>
