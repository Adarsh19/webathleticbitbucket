                           ...
                           <div class="tabs">
                                ...
                                <div class="tab-content">
                                    <div id="overview" class="tab-pane active">
                                            <form id="profile_edit_form" data-parsley-validate class="form-horizontal" action="{{route('admin.addCompanysRoute')}}" method="post">
                                            {{csrf_field()}}
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" name="company_name" class="form-control" id="name" value="{{@old('company_name', '')}}" >
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <input type="text" name="address" class="form-control" id="autocomplete" value="{{@old('address', '')}}" onFocus="geolocate()"   placeholder="ex. House 00, Road 00, New york, United states">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" name="zipcode" class="form-control" id="postal_code" value="{{@old('zipcode', '')}}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="City" class="form-control" id="locality" value="{{@old('City', '')}}">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="state" value="{{@old('state', '')}}" class="form-control" id="administrative_area_level_1" value="">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                   ...
                                                   <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" value="{{@old('Contactpersoon', '')}}" name="Contactpersoon" class="form-control" id="surname">
                                                        <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="phone_main" class="form-control" id="copyright"  value="{{@old('phone_main', '')}}">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" value="{{@old('phone_contact
                                                ...
                                                <div class="form-group col-md-4">
                                                   ...
                                                   <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="phone_administration" class="form-control" id="surname" value="{{@old('phone_administration', '')}}" >
                                                        <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="email" name="email_main" value="{{@old('email_main', '')}}" class="form-control" id="copyright" >
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="email" name="email_contact" class="form-control" id="copyright" value="{{@old('email_contact', '')}}">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                   ...
                                                   <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="email" name="email_administration" value="{{@old('email_administration', '')}}" class="form-control" id="surname">
                                                        <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="kvk_number" value="{{@old('kvk_number', '')}}" class="form-control" id="copyright">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" value="{{@old('btw_number', '')}}" name="btw_number" class="form-control" id="copyright">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" name="primary_language" class="form-control" id="surname" value="{{@old('primary_language', '')}}">
                                                        <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <select name="allow_cashback" class="form-control" id="allow_cashback" >
                                                            ...
                                                            <option value="1" @if(@old('allow_cashback') == 1) selected @endif>Ja</option>
                                                            <option value="2" @if(@old('allow_cashback') == 2) selected @endif>Nee</option>
                                                        </select>
                                                   ...
                                                   <div class="input-group">
                                                        <span class="input-group-addon">
                                                         ...
                                                         <select name="visit_location" class="form-control" id="visit_location" >
                                                            <option value="0" disabled selected>Select One</option>
                                                            <option value="1" @if(@old('visit_location') == 1) selected @endif>Ja</option>
                                                            <option value="2" @if(@old('visit_location') == 2) selected @endif>Nee</option>
                                                        </select>
                                                        <span class="text-danger allow-cashback-error"></span>
                                                    </div>
                                                </div>
