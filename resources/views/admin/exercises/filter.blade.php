<div class="col-md-12 row" style="margin-bottom: 18px;">
    ...
    <div class="col-md-3 ">
        ...
        $goooals_html='<select class="form-control" name="goal" onchange="searchFilter('.$user->id.')">';
    ...
    <div class="col-md-3 ">
        ...
        $traininglevels_html='<select class="form-control" name="traininglevel" onchange="searchFilter('.$user->id.')">';
    ...
    <div class="col-md-3">
        ...
        $traininglevelsmg_html='<select class="form-control" name="musclegroupname" onchange="searchFilter('.$user->id.')">';
    ...
    <div class="col-md-2 ">
        ...
        $materials_html='<select class="form-control" name="materiallevel" onchange="searchFilter('.$user->id.')">';
