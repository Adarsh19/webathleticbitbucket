...
@section('content')
	...
	<!-- /.delete page modal -->
	  <div class="modal fade" id="delete-modal-bulk" role="dialog">
	    <div class="modal-dialog">
	      <div class="modal-content">
	         <form method="POST" action="{{ route('admin.tests.bulkdelete')}}" id="delete-from-bulk">
	        <div class="modal-header">
...
var select_html = '<a href="{{ route('admin.tests.add') }}" class="btn  btn-force btn-info btn-md hvr-grow-shadow pull-right">@lang('common.add_test')</a>';
...
function remove(id){
    var url = "{{ route('admin.tests.destroy', 'id') }}";
