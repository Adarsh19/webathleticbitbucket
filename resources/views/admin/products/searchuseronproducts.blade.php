...
{{--<section class="card mb-3">--}}
    {{--<header class="card-header">--}}
        {{--<div class="card-actions">=--}}
            {{--<a class="card-action card-action-dismiss" data-card-dismiss="" onclick ="closeuserlist(this)"></a>--}}
        {{--</div>--}}
    ...
    {{--<div class="card-body">--}}
        {{--<div class="content">--}}
            {{--<ul class="simple-user-list">--}}
                ...
                {{--<li onclick="clickoption(this)">--}}
                    {{--<input type="hidden" class="userids" id="user-id" value="{{$user->id}}">--}}
                    {{--<figure class="image rounded">--}}
                        {{--<img src="{{ asset('public/web/avatar/groups/'.$user->avatar)}}" alt="{{$user->name}}"  onerror=this.src="{{ asset('admin_files/img/!sample-user.jpg')}}" class="rounded-circle">--}}
                    {{--</figure>--}}
    ...
    <section class="color-cus-black">
        ...
        <div class="card-body">
            <div class="content">
                <ul class="simple-user-list">
                    @foreach($users as $user)
                        <li  style="cursor: pointer"onclick="clickoption_user(this)"  >
